...
def user_report():
    loan_amnt = st.number_input("Enter Loan Amount", 0, 100000)
    installment = st.number_input("Enter Installment Amount", 0, 1000)
    annual_inc = st.number_input("Enter Annual Increment", 0, 100000)
    ...
    grade = st.selectbox('Grades', ('A', 'B', 'C', "D", 'E'))

    emp_length = st.number_input('Expeerience', 1, 20)
